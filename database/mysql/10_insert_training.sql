...
('新员工入职培训', 1, '公司文化、规章制度、安全知识等入职必训内容', '林晓', 8, '公司会议室A', '2024-01-15 09:00:00', '2024-01-15 17:00:00', 30, 25, 2),
('Java高级编程技术', 2, 'Java高级特性、设计模式、性能优化', '张伟', 16, '技术培训室', '2024-02-20 09:00:00', '2024-02-21 17:00:00', 20, 18, 2),
('项目管理实战', 3, '项目管理方法论、敏捷开发、团队协作', '袁鹏', 12, '公司会议室B', '2024-03-10 09:00:00', '2024-03-11 17:00:00', 25, 22, 2),
('安全生产培训', 4, '安全生产法规、应急处理、消防知识', '何军', 4, '公司会议室A', '2024-04-05 09:00:00', '2024-04-05 13:00:00', 50, 45, 2),
('前端开发技术', 2, 'Vue3、React、前端工程化', '朱涛', 12, '技术培训室', '2024-05-15 09:00:00', '2024-05-16 17:00:00', 15, 12, 2),
('数据分析与可视化', 2, 'Python数据分析、ECharts可视化', '李娜', 8, '技术培训室', '2024-06-20 09:00:00', '2024-06-20 17:00:00', 20, 15, 2),
('领导力提升培训', 3, '领导力理论、团队管理、沟通技巧', '林晓', 16, '公司会议室B', '2024-07-10 09:00:00', '2024-07-12 17:00:00', 15, 13, 2),
('沟通技巧培训', 3, '职场沟通、跨部门协作、客户沟通', '邹敏', 4, '公司会议室A', '2024-08-15 09:00:00', '2024-08-15 13:00:00', 30, 28, 2),
('Python编程基础', 2, 'Python基础语法、数据结构、常用库', '王强', 12, '技术培训室', '2024-09-20 09:00:00', '2024-09-21 17:00:00', 20, 16, 2),
('新员工入职培训', 1, '2025年第一期新员工入职培训', '林晓', 8, '公司会议室A', '2025-01-10 09:00:00', '2025-01-10 17:00:00', 30, 20, 1),
('数据库优化技术', 2, 'MySQL性能优化、索引设计、SQL调优', '吴昊', 8, '技术培训室', '2025-02-15 09:00:00', '2025-02-15 17:00:00', 15, 10, 1),
('团队建设活动', 3, '团队协作、信任建立、沟通训练', '袁鹏', 8, '户外拓展基地', '2025-03-20 09:00:00', '2025-03-20 17:00:00', 40, 35, 0);
    ...
    course_loop: LOOP
        ...
        BEGIN
            ...
            emp_loop: LOOP
                ...
                -- 插入报名记录(使用IGNORE避免重复数据冲突)
                INSERT IGNORE INTO training_enrollment (course_id, emp_id, enrollment_time, approval_status, attendance_status, score, feedback)

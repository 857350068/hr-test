...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'admin/rules', name: 'RuleManagement', component: () => import('@/views/admin/RuleManagementView.vue'), meta: { requiresAdmin: true, title: '分析规则管理' } },
      { path: 'admin/models', name: 'ModelManagement', component: () => import('@/views/admin/ModelManagementView.vue'), meta: { requiresAdmin: true, title: '预警模型管理' } },
      { path: 'admin/report-schedules', name: 'ReportSchedule', component: () => import('@/views/admin/ReportScheduleView.vue'), meta: { requiresAdmin: true, title: '报表定时任务' } },

...
public class TrainingController {
    ...
    @GetMapping("/effect/overview")
    public Result<Object> getTrainingEffectOverview() {
        try {
            return Result.success("查询成功", trainingEnrollmentService.getTrainingEffectOverview());
        } catch (Exception e) {
            log.error("查询培训效果概览失败: {}", e.getMessage());
            return Result.error("查询培训效果概览失败");
        }
    }

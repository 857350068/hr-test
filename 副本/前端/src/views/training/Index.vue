<template>
    <div class="training-management">
        ...
        <el-row :gutter="20" style="margin-bottom: 20px">
            <el-col :span="6"><el-card><div class="summary-label">报名总数</div><div class="summary-value">{{ trainingOverview.totalEnrollments || 0 }}</div></el-card></el-col>
            <el-col :span="6"><el-card><div class="summary-label">到课率</div><div class="summary-value">{{ trainingOverview.attendanceRate || 0 }}%</div></el-card></el-col>
            <el-col :span="6"><el-card><div class="summary-label">平均成绩</div><div class="summary-value">{{ trainingOverview.avgScore || 0 }}</div></el-card></el-col>
            <el-col :span="6"><el-card><div class="summary-label">反馈条数</div><div class="summary-value">{{ trainingOverview.feedbackCount || 0 }}</div></el-card></el-col>
        </el-row>
...
const loadTrainingOverview = async () => {
    const res = await getTrainingEffectOverview()

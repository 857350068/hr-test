<template>
    <div class="performance-management">
        ...
        <el-row :gutter="20" style="margin-bottom: 20px">
            <el-col :span="6"><el-card><div class="summary-label">评估总数</div><div class="summary-value">{{ improvementOverview.totalEvaluations || 0 }}</div></el-card></el-col>
            <el-col :span="6"><el-card><div class="summary-label">已完成</div><div class="summary-value">{{ improvementOverview.completedCount || 0 }}</div></el-card></el-col>
            <el-col :span="6"><el-card><div class="summary-label">待改进</div><div class="summary-value">{{ improvementOverview.needImproveCount || 0 }}</div></el-card></el-col>
            <el-col :span="6"><el-card><div class="summary-label">平均得分</div><div class="summary-value">{{ improvementOverview.avgFinalScore || 0 }}</div></el-card></el-col>
        </el-row>
...
const loadImprovementOverview = async () => {
    const res = await getImprovementOverview()
    improvementOverview.value = res.data || {}
}
